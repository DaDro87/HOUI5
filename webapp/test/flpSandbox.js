		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atclouddnatraining02zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnatraining02zhoui5-display": {
								"semanticObject": "atclouddnatraining02zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.training02.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/training02/zhoui5")
								}
							}
						}
					}
